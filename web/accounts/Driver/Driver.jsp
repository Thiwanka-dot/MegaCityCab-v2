            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul>
                        ...
                        <li>Indicate your availability by clicking "Available" or "Unavailable."</li>
                        <li>Ensure that all your contact and vehicle information is accurate.</li>
                        <li>If you wish to delete your account, be aware that this action is permanent.</li>
                        <li>Contact us for any queries or assistance regarding your profile or bookings.</li>
